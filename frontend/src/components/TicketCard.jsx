  ...
  return (
    <article className="rounded-xl border border-slate-200 bg-white p-5 transition-shadow hover:shadow-md">
      <div className="mb-3 flex flex-wrap items-center gap-2">
        ...
        <Badge className="border-slate-200 bg-slate-50 text-slate-600">{category}</Badge>
      ...
      <Link to={`/tickets/${ticket.id}`} className="group block">
        <p className="mb-3 line-clamp-3 text-sm leading-relaxed text-slate-700 group-hover:text-slate-900">
          {ticket.description}
        </p>
      </Link>
