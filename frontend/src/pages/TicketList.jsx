  ...
  return (
    <div>
      <div className="mb-6 flex flex-wrap items-center justify-between gap-3">
        <div>
          <h1 className="text-2xl font-semibold text-slate-900">Campus issues</h1>
      ...
      {error && (
        <div
          role="alert"
          className="mb-4 flex items-start gap-2 rounded-lg border border-red-200 bg-red-50 p-4 text-sm text-red-800"
        >
      ...
      {loading ? (
        ...
        <div className="rounded-xl border border-dashed border-slate-300 bg-white py-16 text-center">
          <Inbox size={40} className="mx-auto mb-3 text-slate-300" aria-hidden="true" />
          <h2 className="mb-1 font-medium text-slate-900">No issues found</h2>
