...
export default function AdminDashboard() {
  ...
  return (
    <div>
      <h1 className="mb-1 text-2xl font-semibold text-slate-900">Representative dashboard</h1>
      <p className="mb-6 text-sm text-slate-600">Campus-wide issue overview.</p>
      ...
      {loading ? (
        ...
        <div className="rounded-xl border border-dashed border-slate-300 bg-white py-12 text-center">
          <p className="font-medium text-slate-900">Nothing overdue</p>
